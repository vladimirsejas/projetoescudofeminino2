...
df = pd.read_sql("""
SELECT tipo_cancer, AVG(dias_permanencia) AS permanencia_media,
...
print(f"\n=== PERMANÊNCIA HOSPITALAR ({MUNICIPIO}) ===\n")
print(df)
df.to_sql("permanencia_hospitalar", conn, if_exists="replace", index=False)
